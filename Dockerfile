...
RUN DEBIAN_FRONTEND=noninteractive apt-get -y update
RUN DEBIAN_FRONTEND=noninteractive apt-get -y --fix-missing -q install php7.1-fpm php7.1-gd php7.1-sqlite php7.1-mysqlnd php7.1-curl php7.1-intl php7.1-xml php7.1-mbstring php7.1-json php7.1-mcrypt php7.1-bcmath php7.1-soap php7.1-zip
